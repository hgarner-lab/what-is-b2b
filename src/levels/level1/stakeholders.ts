...
export const STAKEHOLDERS: Stakeholder[] = [
  { id: 'cmo', role: 'CMO', ask: 'Sounds great.', again: 'Can you convince the CFO?' },
  { id: 'cfo', role: 'CFO', ask: 'What’s the return?', again: 'Can we pay less?' },
  { id: 'cio', role: 'CIO', ask: 'Will it work with our systems?', again: 'Who fixes it when it breaks?' },
